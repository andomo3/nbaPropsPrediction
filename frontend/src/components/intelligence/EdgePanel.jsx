                    ...
                    <>
                        ...
                        >
                            ...
                            {bands.map((b, i) => {
                                ...
                                // Buckets grow left to right, so the eye reads the
                                // ramp in the order the story is told.
                                const delay = `${i * 70}ms`;
                                return (
                                    <div key={b.bucket} className="flex flex-col justify-end h-full gap-3">
                                        <div
                                            className="num text-lg sm:text-[22px] font-medium text-center leading-none motion-rise"
                                            style={{
                                                color: isBest ? C.acid : b.hit_rate >= BREAK_EVEN ? C.ink2 : C.ink4,
                                                '--motion-delay': delay,
                                            }}
                                        >
                                            {pct(b.hit_rate)}
                                        ...
                                        <div
                                            className="rounded-t motion-grow-y"
                                            style={{
