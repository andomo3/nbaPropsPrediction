...
import {
    Band, Eyebrow, FootNotes, GhostSelect, PageHead, Tabs,
} from './terminal/ui';
...
export default function PlayerIntelligence() {
    ...
    return (
        <>
            ...
            {/* Verdict strip — same three-claim treatment as the report card. */}
            <Band className="py-14">
                <div className="flex flex-col">
                    <div className="flex flex-col min-w-0">
                        <Eyebrow section>Overall verdict</Eyebrow>
                        {verdict ? (
                        ...
                        <VerdictClaims validation={v} className="mt-10" />
                    </div>
